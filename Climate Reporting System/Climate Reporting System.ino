...
#define CHANNEL_ID 1973437 // the channel ID of the channel of our GUI.
#define CHANNEL_API_KEY "J2AHQOMD1GZ6VAZ6" // the channel API KEY of the channel of our GUI.
